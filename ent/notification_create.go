...
func (nc *NotificationCreate) SetTitleKey(s string) *NotificationCreate {
	nc.mutation.SetTitleKey(s)
	return nc
}

// SetData sets the "data" field.
func (nc *NotificationCreate) SetData(sd schema.NotificationData) *NotificationCreate {
...
func (nc *NotificationCreate) check() error {
	...
	if _, ok := nc.mutation.TitleKey(); !ok {
...
func (nc *NotificationCreate) createSpec() (*Notification, *sqlgraph.CreateSpec) {
	...
	if value, ok := nc.mutation.TitleKey(); ok {
